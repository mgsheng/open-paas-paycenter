...
public class PayserviceDev {
	...
	public String ali_service;
	public String ali_input_charset;
	public String wx_app_id;
	public String wx_mch_id;
	public String wx_key;
	public String wx_spbill_create_ip;
	public String wx_notify_url;
	private String wx_ufdooer_url;
	...
	private String ali_gateway_new;
	
	
	public String getWx_urlCode_path() {
		return wx_urlCode_path;
	}
	public void setWx_urlCode_path(String wx_urlCode_path) {
		this.wx_urlCode_path = wx_urlCode_path;
	}
	public String getWx_trade_type() {
		return wx_trade_type;
	}
	public void setWx_trade_type(String wx_trade_type) {
		this.wx_trade_type = wx_trade_type;
	}
	...
	public String getWx_spbill_create_ip() {
		return wx_spbill_create_ip;
	}
	public void setWx_spbill_create_ip(String wx_spbill_create_ip) {
		this.wx_spbill_create_ip = wx_spbill_create_ip;
	}
	...
	public String getWx_ufdooer_url() {
		return wx_ufdooer_url;
	}
	public void setWx_ufdooer_url(String wx_ufdooer_url) {
		this.wx_ufdooer_url = wx_ufdooer_url;
	}
	public String getNotify_times() {
		return notify_times;
	}
	public void setNotify_times(String notify_times) {
	...
	public String getAli_gateway_new() {
		return ali_gateway_new;
	}
	public void setAli_gateway_new(String ali_gateway_new) {
		this.ali_gateway_new = ali_gateway_new;
	}
