...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="changeCardResendsms" method="post" class="form-horizontal" target="_blank">
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="changeCardResendsmsUri" id="changeCardResendsmsUri" value="${changeCardResendsmsUri}"/>
...
<script type="text/javascript">
	function btnSubmit(){
		...
		var changeCardResendsmsUri=$("#changeCardResendsmsUri").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
				    ...
				    var regUri=changeCardResendsmsUri+"?"+"outTradeNo="+outTradeNo+"&requestNo="+requestNo+"&appId="+appId+"&merchantId="+merchantId+"&requestNo="+requestNo+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
