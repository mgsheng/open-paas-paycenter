...
<html>
<head>
    <title>bind-card-confirm(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="bindCardConfirm" method="post" class="form-horizontal" target="_blank">
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="bindCardConfirmUri" id="bindCardConfirmUri" value="${bindCardConfirmUri}"/>
...
<script type="text/javascript">
	function btnSubmit(){
		...
		var bindCardConfirmUri=$("#bindCardConfirmUri").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
				    ...
				    var regUri=bindCardConfirmUri+"?"+"outTradeNo="+outTradeNo+"&requestNo="+requestNo+"&appId="+appId+"&merchantId="+merchantId+"&requestNo="+requestNo+"&validateCode="+validateCode+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
