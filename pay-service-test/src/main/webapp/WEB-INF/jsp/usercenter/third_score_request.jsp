...
<html>
<head>
    <title>third-score-request(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="thirdScore" method="post" class="form-horizontal" target="_blank">
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="thirdScoreUri" id="thirdScoreUri" value="${thirdScoreUri}"/>
                ...
                <div ng-show="visible">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-sm-2 control-label">reasonNo</label>

                        <div class="col-sm-10">
							<select name="reasonNo" id="reasonNo" class="form-control" ng-mode="reasonNo">
								<option value="01">贷款审批</option>
								<option value="02">贷中管理</option>
								<option value="03">贷后管理</option>
								<option value="04">本人查询</option>
								<option value="05">异议查询</option>
								<option value="99">其他</option>
							</select>
                            <p class="help-block">01:贷款审批；02:贷中管理；03:贷后管理；04:本人查询;05--异议查询；99--其他（必传）</p>
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary" id="thirdScoreUrL"></div> 
                    </div>
                </div>
                <br/>
                <br/>
...
<script type="text/javascript">
	function btnSubmit(){
		...
		var reasonNo=$("#reasonNo").val();
		var cardNo=$("#cardNo").val();
		var thirdScoreUri=$("#thirdScoreUri").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
				    ...
				    var regUri=userUnifyPayUri+"?"+"outTradeNo="+outTradeNo+"&userName="+userName+"&userId="+userId+"&appId="+appId+"&merchantId="+merchantId+"&certNo="+certNo+"&channelId="+channelId+"&mobile="+mobile+"&reasonNo="+reasonNo+"&cardNo="+cardNo+"&parameter="+parameter+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
					$("#thirdScoreUrl").html(regUri);
				}else{
				    jQuery("#thirdScoreUrl").html('无效数据，请重新申请');
				}
			}
 		);
	}
