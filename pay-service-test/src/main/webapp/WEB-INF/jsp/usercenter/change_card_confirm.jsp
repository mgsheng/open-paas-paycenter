...
<html>
<head>
    <title>change-card-confirm(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="changeCardConfirm" method="post" class="form-horizontal" target="_blank">
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="changeCardConfirmUri" id="changeCardConfirmUri" value="${changeCardConfirmUri}"/>
                ...
                <div ng-show="visible">
					...
					<div class="form-group">  
                     ...
                     <div class="form-group">
                        <label class="col-sm-2 control-label">validateCode</label>

                        <div class="col-sm-10">
                            <input type="text" name="validateCode" id="validateCode" size="50" class="form-control"
                                   ng-model="validateCode"/>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用换卡确认接口</button>
...
<script type="text/javascript">
	function btnSubmit(){
		...
		var changeCardConfirmUri=$("#changeCardConfirmUri").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
				    ...
				    var regUri=changeCardConfirmUri+"?"+"outTradeNo="+outTradeNo+"&requestNo="+requestNo+"&appId="+appId+"&merchantId="+merchantId+"&requestNo="+requestNo+"&validateCode="+validateCode+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
