    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-10">
				...
				<!-- <form class="form-horizontal" action="${accessTokenUri}" onsubmit="return false;"> -->
                <form class="form-horizontal" action="${accessTokenUri}">
                    ...
                    <br/>
                    <br/>
                    <button  type="submit" class="btn btn-primary" >获取access_token</button>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div ng-show="tokenVisible" class="col-md-11">
                ...
                <a href="${userUserInfoUri}?access_token={{accessToken}}" target="_blank">${userUserInfoUri}?access_token={{accessToken}}</a>
