    ...
    <div class="panel-body">
        ...
        <ul>
            <li>
                ...
                <br/>
                <a href="${contextPath}/user_user_info?access_token=${accessTokenDto.accessToken}">Oauth Server
                    用户信息</a>
            </li>
            <li>
                方式2: 直接通过access_token去访问服务器的资源(该方式将直接获取JSON数据)
                <br/>
                <a href="${userUserInfoUri}?access_token=${accessTokenDto.accessToken}" target="_blank">Oauth Server
                    用户信息
                    [JSON]</a>
            </li>
            <li>...</li>
