		            	...
		            	<div class="page_msg mini">
							...
							<c:if test="${bool=='false'}">
								<div class="inner">
									...
									<div class="msg_content">
										<p>
											设置密保问题失败，密保问题已存或填写数据有误！
										</p>
									</div>
								</div>
							</c:if>
						</div>
		                <form id="form" action="${pageContext.request.contextPath}/dev/user/addproblem" method="post">
			                <ul class="basic_info_text clearfix">
			                	...
			                	<li>
			                		<a id="btn_info" class="revise_info" href="javascript:void(0);" onclick="formSubmit();">设置</a>
			                	</li>
			                </ul>
		                </form>
		            </div>
