 ...
 *
 */
public class UnifyCostsControllerLog {
	
	private static final Logger logger = LoggerFactory.getLogger(UnifyCostsControllerLog.class);
	 ...
	 * @param map 
	 */
	public static void log(long startTime,String outTradeNo,String sourceId,String merchantId, String totalFee, Map<String, Object> map){
		try {
