 ...
 */
@Controller
@RequestMapping("/tzt/notify")
public class TZTNotifyCallbackController extends BaseControllerUtil {
	private static final Logger log = LoggerFactory.getLogger(TZTNotifyCallbackController.class);
	 @Autowired
	...
	public void tztNotifyCallBack(HttpServletRequest request,HttpServletResponse response,Map<String,Object> model) throws MalformedURLException, DocumentException, IOException {
		   ...
		   String data					= formatString(request.getParameter("data"));
            ...
            PayServiceLog payServiceLog=new PayServiceLog();
	   		 ...
	   		 payServiceLog.setLogName(PayLogName.BIND_CARD_NOTIFY_START);
