...
public class OrderRefundData {
	public static Map<String, String> buildOrderrefundDataMap(String name) {
		...
		orderQryDataMap.put(HytParamKeys.OUT_TRADE_NO, "20150725110244776");
		orderQryDataMap.put(HytParamKeys.ORDER_TIME, orderTime);
		orderQryDataMap.put(HytParamKeys.SERVICE, "OrderRefund");
		orderQryDataMap.put(HytParamKeys.REFUND_AMOUNT,"1");
