...
public class OrderQryService {
	 ...
	 * @param dataMap
	 */
	public void query(Map<String, String> dataMap) {
		...
		try {
            ...
            // -- 验证签名
				...
				System.out.println("正常返回,商户可进行后续逻辑处理............{\"charset\":\""+(String)retMap.get("charset")+"\",\"version\":\""
						    ...
						    +"\",\"status\":\""+(String)retMap.get("status")+"\",\"order_time\":\""+(String)retMap.get("order_time")+"\",\"total_amt\":\""+(String)retMap.get("total_amt")+"\",\"channel_code\":\""+(String)retMap.get("channel_code")+"\",\"pay_time\":\""+(String)retMap.get("pay_time")+"\",\"buyer_id\":\""+(String)retMap.get("buyer_id")+"\",\"fee\":\""+(String)retMap.get("fee")+"\"}");		
