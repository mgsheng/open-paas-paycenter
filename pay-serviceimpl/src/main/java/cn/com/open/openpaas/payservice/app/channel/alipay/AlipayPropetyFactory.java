...
public class AlipayPropetyFactory {
	...
	public static AlipayUtil getAlifafUtil(MerchantOrderInfo merchantOrderInfo,
			DictTradeChannelService dictTradeChannelService) {
		if (merchantOrderInfo != null) {
			DictTradeChannel dictTradeChannels = dictTradeChannelService
					.findByMAI(
							String.valueOf(merchantOrderInfo.getMerchantId()),
							Channel.ALIFAF.getValue());
