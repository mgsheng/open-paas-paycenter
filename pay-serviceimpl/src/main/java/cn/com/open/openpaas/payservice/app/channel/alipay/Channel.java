...
public enum Channel{
    ...
    ,WECHAT_WAP(10011),EHK_BANK(10012),PAYMAX_WECHAT_CSB(10013),TZT(10014),PAYMAX_H5(10015),YEEPAY_WEIXIN(10016),YEEPAY_ALI(10017),YEEPAY_ALL(10018),EHK_ALI_PAY(10019);
