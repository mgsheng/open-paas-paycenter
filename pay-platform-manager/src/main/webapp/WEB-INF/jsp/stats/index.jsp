			...
			<div style="margin-top: 5px">
				...
				<div style="margin-left: 180px; display: inline-block;">
					<a href="#" class="easyui-linkbutton" data-options="plain:true"
						onclick="getDayType('seven')">7天</a> <a href="#" class="easyui-linkbutton"
						data-options="plain:true" onclick="getDayType('thirty')">30天</a>

					<div style="display:inline-block;margin-left: 10px">
						&nbsp;累计 &nbsp; <input class="easyui-datebox"
							data-options="onSelect:onStartSelect" style="width:150px; " id="aa">
					</div>
					&nbsp;至&nbsp;
		...
		<div
			...
			<table style="width: 100%; height: 100%; text-align: center; ">
				...
				<tr
					...
					<td><div id="totalPayAmount" style="">0.0</div></td>
					<td><div id="totalPayCount" style="">0</div></td>
					<td><div id="totalUserCount" style="">0</div></td>
					<td><div id="totalPayCharge" style="">0.0</div></td>
				</tr>
			</table>
		</div>
	</div>
